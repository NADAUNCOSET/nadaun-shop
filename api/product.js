...
module.exports=function handler(req,res){
 ...
 const description=(p.name+' 상품 정보와 구매 안내. 나다운 샵에서 만나보세요.').slice(0,80);
